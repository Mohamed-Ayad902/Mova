...
class SearchedTvShowAdapter(
    private val listener: OnTvShowClickListener,
    private val context: Context
) :
    RecyclerView.Adapter<SearchedTvShowAdapter.SearchedTvShowVH>() {

    inner class SearchedTvShowVH(val binding: SavedItemBinding) :
    ...
    override fun onBindViewHolder(holder: SearchedTvShowVH, position: Int) {
