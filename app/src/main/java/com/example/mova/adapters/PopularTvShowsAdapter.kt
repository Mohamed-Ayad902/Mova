...
class PopularTvShowsAdapter(
    ...
    RecyclerView.Adapter<PopularTvShowsAdapter.PopularTvShowsVH>() {

    inner class PopularTvShowsVH(val binding: PopularMoviesItemBinding) :
    ...
    override fun onBindViewHolder(holder: PopularTvShowsVH, position: Int) {
