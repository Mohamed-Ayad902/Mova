...
class AllMoviesAdapter(
    ...
    RecyclerView.Adapter<AllMoviesAdapter.AllMoviesVH>() {

    inner class AllMoviesVH(val binding: SavedItemBinding) :
    ...
    override fun onBindViewHolder(holder: AllMoviesVH, position: Int) {
