...
class OnAirTvShowsAdapter(
    private val listener: OnTvShowClickListener,
    private val context: Context
) :
    RecyclerView.Adapter<OnAirTvShowsAdapter.OnAirTvShowsVH>() {

    inner class OnAirTvShowsVH(val binding: PopularMoviesItemBinding) :
    ...
    override fun onBindViewHolder(holder: OnAirTvShowsVH, position: Int) {
