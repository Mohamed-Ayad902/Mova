...
class RecommendedMoviesAdapter(
    ...
    RecyclerView.Adapter<RecommendedMoviesAdapter.RecommendedMoviesVH>() {

    inner class RecommendedMoviesVH(val binding: PopularMoviesItemBinding) :
    ...
    override fun onBindViewHolder(holder: RecommendedMoviesVH, position: Int) {
