...
class SimilarTvShowAdapter(
    ...
    RecyclerView.Adapter<SimilarTvShowAdapter.SimilarTvShowVH>() {

    inner class SimilarTvShowVH(val binding: PopularMoviesItemBinding) :
    ...
    override fun onBindViewHolder(holder: SimilarTvShowVH, position: Int) {
