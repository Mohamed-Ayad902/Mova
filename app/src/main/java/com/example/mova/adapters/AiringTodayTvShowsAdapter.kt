...
class AiringTodayTvShowsAdapter(
    private val listener: OnTvShowClickListener,
    private val context: Context
) :
    RecyclerView.Adapter<AiringTodayTvShowsAdapter.AiringTodayTvShowsVH>() {

    inner class AiringTodayTvShowsVH(val binding: PopularMoviesItemBinding) :
    ...
    override fun onBindViewHolder(holder: AiringTodayTvShowsVH, position: Int) {
